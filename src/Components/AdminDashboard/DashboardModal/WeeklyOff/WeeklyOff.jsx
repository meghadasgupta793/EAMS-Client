...
const WeeklyOff = ({ open, onClose, data }) => {
    ...
    return (
        <Modal open={open} onClose={onClose} aria-labelledby="weekly-off-modal">
            <Box className='weekly-off-modal-container'>
                <div className='weekly-Off-container'>
                    <div className='weekly-off-header-container'>
                        <h1 className='weekly-off-heading'>Weekly Off List</h1>
                        <div className='weekly-off-icon-container'>
                            <Tooltip title="Search">
                                <IconButton onClick={() => setSearchActive(!searchActive)}>
                                    <SearchIcon className='weekly-off-header-icon' />
                                </IconButton>
                            </Tooltip>
                            <Tooltip title="Export Employee Details in Excel">
                                <IconButton onClick={handleExport}>
                                    <FileDownloadIcon className='weekly-off-header-icon' />
                                </IconButton>
                            </Tooltip>
                            <Tooltip title="Close">
                                <IconButton onClick={onClose}>
                                    <CloseIcon className='weekly-off-header-icon' />
                                </IconButton>
                            </Tooltip>
                        </div>
                    </div>
                    ...
                    <table className='weekly-off-table'>
                        <thead>
                            <tr>
                                <th>Photo</th>
                                <th>Emp No</th>

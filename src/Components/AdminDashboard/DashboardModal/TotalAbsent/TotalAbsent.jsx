...
const TotalAbsent = ({ open, onClose, data }) => {
  ...
  return (
    <Modal open={open} onClose={onClose} aria-labelledby="total-absent-modal">
      <Box className='total-absent-modal-container'>
        <div className='total-absent-container'>
          <div className='total-absent-header-container'>
            <h1 className='total-absent-heading'>Absent List</h1>
            <div className='total-absent-icon-container'>
              <Tooltip title="Search">
                <IconButton onClick={() => setSearchActive(!searchActive)}>
                  <SearchIcon className='total-absent-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Export Employee Details in Excel">
                <IconButton onClick={handleExport}>
                  <FileDownloadIcon className='total-absent-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Close">
                <IconButton onClick={onClose}>
                  <CloseIcon className='total-absent-header-icon' />
                </IconButton>
              </Tooltip>
            </div>
          </div>
          ...
          <table className='total-absent-table'>
            <thead>
              <tr>
                <th>Photo</th>
                <th>Emp No</th>

...
const EarlyExit = ({ open, onClose, data }) => {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      aria-labelledby="early-exit-modal"
      aria-describedby="modal-to-view-early-exit-list"
    >
      <Box className='early-exit-modal-container'>
        <div className='earlyExit-container'>
          <div className='early-exit-header-container'>
            <h1 className='early-exit-heading'>Early Exit List</h1>
            <div className='early-exit-icon-container'>
              <Tooltip title="Search">
                <IconButton onClick={() => setSearchActive(!searchActive)}>
                  <SearchIcon className='early-exit-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Export Employee Details in Excel">
                <IconButton onClick={handleExport}>
                  <FileDownloadIcon className='early-exit-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Close">
                <IconButton onClick={onClose}>
                  <CloseIcon className='early-exit-header-icon' />
                </IconButton>
              </Tooltip>
            </div>
          </div>
          ...
          <table className='early-exit-table'>
            <thead>
              <tr>
                <th>Photo</th>
                <th>Emp No</th>

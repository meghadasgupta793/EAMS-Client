...
const OnLeave = ({ open, onClose, data }) => {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      aria-labelledby="on-leave-modal"
      aria-describedby="modal-to-view-on-leave-list"
    >
      <Box className='on-leave-modal-container'>
        <div className='on-leave-container'>
          <div className='on-leave-header-container'>
            <h1 className='on-leave-heading'>On Leave List</h1>
            <div className='on-leave-icon-container'>
              <Tooltip title="Search">
                <IconButton onClick={() => setSearchActive(!searchActive)}>
                  <SearchIcon className='on-leave-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Export Employee Details in Excel">
                <IconButton onClick={handleExport}>
                  <FileDownloadIcon className='on-leave-header-icon' />
                </IconButton>
              </Tooltip>
              <Tooltip title="Close">
                <IconButton onClick={onClose}>
                  <CloseIcon className='on-leave-header-icon' />
                </IconButton>
              </Tooltip>
            </div>
          </div>
          ...
          <table className='on-leave-table'>
            <thead>
              <tr>
                <th>Photo</th>
                <th>Emp No</th>

...
const AddReportingHeadOrReportee = ({ open, handleClose }) => {
    ...
    const [selectedRequestType, setSelectedRequestType] = useState(null); // State for selected request type

    const dummyData = {
        ou: ['OU1', 'OU2', 'OU3'],
        departments: ['HR', 'Finance', 'Engineering'],
        designations: ['Manager', 'Developer', 'Analyst'],
        levels: ['Level 1', 'Level 2', 'Level 3'], // Dummy levels
        requestTypes: ['Leave', 'Tour', 'Training', 'Other'] // Dummy request types
    };
    ...
    const handleRequestTypeChange = (selectedOption) => {
        setSelectedRequestType(selectedOption);
    };
    ...
    const levelOptions = dummyData.levels.map(level => ({
        value: level,
        label: level
    }));

    const requestTypeOptions = dummyData.requestTypes.map(type => ({
        value: type,
        label: type
    }));
                ...
                <Box className="addReportingHeadOrReportee-content">
                    ...
                    <div className='addReportingHeadOrReportee-search-approver'>
                        ...
                        <div className='addReportingHeadOrReportee-search-items'>
                            {/* Multi-select fields on the left */}
                    ...
                    <div className='addReportingHeadOrReportee-level-req-type'>
                        <h1 className='addReportingHeadOrReportee-level-req-type-heading'>Select Level and Request Type</h1>
                        <div className='addReportingHeadOrReportee-level-req-type-container'>
                            {/* Container for Select Level and Request Type */}
                            <div className='addReportingHeadOrReportee-level-req-type-fields'>
                                ...
                                {/* Select Request Type */}
                                <div className='addReportingHeadOrReportee-request-type-container'>
                                    <Select
                            ...
                            {/* Assign Button */}
                            <button className="addReportingHeadOrReportee-assign-btn">Assign</button>
                        </div>
                    </div>
                </Box>
            </div>
